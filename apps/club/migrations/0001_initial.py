    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.DecimalField(decimal_places=4, max_digits=4)),
                ('address', models.CharField(max_length=400, unique=True)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='clubs', to='category.categoryclub')),
            ],
        ),
        migrations.CreateModel(
            name='ClubImage',
